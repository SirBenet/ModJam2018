# Summon it
summon armor_stand ~ ~-2 ~ {Tags:["BattleBalloon","BattleBalloonStand","BattleBalloonNew"],Invisible:1b,Pose:{Head:[90f,0f,0f]},ArmorItems:[{},{},{},{id:"leather_boots",Count:1,tag:{Damage:5,Unbreakable:1b,display:{color:99999}}}],Passengers:[{id:"armor_stand",Tags:["Spacer"],Invisible:1b,Passengers:[{Tags:["BattleBalloonPig"],id:"horse",Tame:1b}]}]}
