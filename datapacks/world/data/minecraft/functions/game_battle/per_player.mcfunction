...
# Max XP: 742
# Increase when on level 0, by an amount depending on how much time is left
...
xp add @s[level=101] 99899 levels
xp add @s[level=100000] 874000 points
xp add @s[level=100000] -99999 levels
xp add @s[level=100001] -1000000 levels
